...
#include <stdbool.h>//TODO remove at end
#include <unistd.h>//TODO remove at end
#include <stdlib.h>//TODO remove at end
*/
//TODO remove at end
...
extern float IDC;//TODO: remove at end. to calc medium value of IDC 
...
#define Wn Vmax/(Ls*sqrt(Idn*Idn+ro*ro*(Imax*Imax-Idn*Idn)))
#define	Wc Vmax/(Imax*Ls)*sqrt((ro*ro+1.0)/(2.0*ro*ro))
