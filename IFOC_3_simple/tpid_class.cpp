...
_pid::_pid()
{
 ...
 this->setpoint_ = 0.0;				
 this->minimum_pid_ = -900.0;//TODO.? Put 400 because not call torque_control.act_min_max and igbt of report limited to 400			
 this->maximum_pid_ = 900.0;//?		
 ...
 *           limit
 ...
 //------------------------------------------------------------------------*/
void _pid::init_pid(/*int*/float pp,/*int*/float sp, float min, float max, float accel)
{
	this->last_err_ = 0.0;
	this->current_err_ = 0.0;
...
void _pid::act_min_max(float mini, float maxi){
