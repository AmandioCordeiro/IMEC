...
class _pid{
 ...
 public:
  ...
  inline void set_setpoint(float sp){ setpoint_ = sp; }
  ...
  //------------------------------------------------------------------------//
	...
	void init_pid(/*int*/float pp,/*int*/float sp, float min, float max, float accel);
	float calc_pid();
	void act_min_max(float mini, float maxi);
};
#endif	/* _TPID_CLASS_H */
