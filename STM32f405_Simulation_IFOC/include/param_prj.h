...
#define AUTOMATION_CONTACT_PWM_COMM_PARAMETERS \
    ...
    PARAM_ENTRY(CAT_COMM,    car_speed,     "km/h",    -150,   150,     0,      159) \
    PARAM_ENTRY(CAT_COMM,    dr_cycle_sp,   "km/h",   -150,   150,     0,      160) \
    PARAM_ENTRY(CAT_COMM,    motor_efficiency, "%",    -100,   100,     0,      161) \
    TESTP_ENTRY(CAT_TEST,    manualstart, ONOFF,     0,      1,      0,      150 ) 

//AMRC added 3 previous lines
