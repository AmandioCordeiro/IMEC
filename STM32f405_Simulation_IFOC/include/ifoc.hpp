...
#define vel_cel 2.0//(0.05)//alterei(0.03*10)//?TODO					//max aceleration at setpoint
...
#define torque_control_cel (8.0)//400.0//?
...
#define current_control_q_i 0.0006//0.0000005//0.00005(0.00625)//0.0625//?
...
#define current_control_d_Max_pid_res 100//(100.0 )//100?mudei TODO
#define current_control_d_cel 1.0//0.1 0.05//0.04//?mudei

extern const float  Lls, Ls , ro , Ls_ro , TM1 , ro_ro_Ls_Ls_Ls_Ls__KT__KT , Imax_Imax , Imax_Imax_Imax_Imax , Imax_Imax__2 , KT , four__KT_KT;
...
//#define SIZE_AVR_FILT_LMA 23//TODO was 13
...
// extern float Rd_we; extern float Rq_we;
...
//	  float get_VDC();
	  ...
	  void GetDutyCycles(float il1_, float il2_, float VDC, float w_ref/*commanded rotor speed*/, float wr_/*rotor speed*/);
	  bool exc_v_PI();
	  float il3/*, IDC*/;
...
float IDQ_d_lma_avr_;
	 ...
	 static float const_VDQ_d , const_VDQ_q ;
	  int n_rtc;
