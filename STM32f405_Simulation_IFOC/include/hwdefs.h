...
#define OCURMAX 4096
#define USART_BAUDRATE 115200//9600
//Maximum PWM frequency is 36MHz/2^MIN_PWM_DIGITS
#define MIN_PWM_DIGITS 11

#define PWM_TIMER     TIM1
#define PWM_TIMRST    RST_TIM1
#define PWM_TIMER_IRQ NVIC_TIM1_UP_TIM10_IRQ /* //TODO stm32F4 AMRC *///NVIC_TIM1_UP_IRQ 
...
//TODO STM32F4 AMRC
#define FLASH_PAGE_SIZE ( 16 * 1024 )//sector 1 16k .sector 5 a 11 128k   TODO STM32F4 AMRC, 1024
#define PARAM_BLKSIZE ( 16 * 1024 ) //.sector 5 a 11 128k
...
#define REV_CNT_DMASTREAM    hwRev == HW_REV1 ? DMA2_STREAM0 : DMA1_STREAM5//?? TODO STM32F4 AMRC ?? REV_CNT_DMACHAN    hwRev == HW_REV1 ? DMA_CHANNEL2 : DMA_CHANNEL6
