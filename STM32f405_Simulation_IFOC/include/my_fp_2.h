...
#define FRAC_DIGITS 13//5
//#define CST_DIGITS 6//13 TODO experimentar c 20. EDIT. controladores nao func. com mais de 16
...
#define FP_MUL(a, b) (s32fp)(((int64_t)(a) * (int64_t)(b)) / (1 << CST_DIGITS))
#define FP_DIV(a, b) (s32fp)(((int64_t)(a) * (1 << CST_DIGITS)) / (b))
