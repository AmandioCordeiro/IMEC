...
#define AUTOMATION_CONTACT_PWM_COMM_PARAMETERS \
    ...
    PARAM_ENTRY(CAT_COMM,    car_speed,     "km/h",    -150,   150,     0,      150) \
    PARAM_ENTRY(CAT_COMM,    dr_cycle_sp,   "km/h",   -150,   150,     0,      151) \
    PARAM_ENTRY(CAT_COMM,    motor_efficiency, "%",    -100,   100,     0,      152) \
