...
{
   { USART1, DMA2_Stream7, GPIOA, GPIO_USART1_TX },//TODO STM32F4 AMRC??DMA_CHANNEL4,
   { USART2, DMA1_Stream6, GPIOA, GPIO_USART2_TX },//TODO STM32F4 AMRC??DMA_CHANNEL7
   { USART3, DMA1_Stream3, GPIOB, GPIO_USART3_TX },//TODO STM32F4 AMRC?? DMA_CHANNEL2
};
...
//TODO STM32F4 AMRC
   //gpio_set_mode(hw->port, GPIO_MODE_OUTPUT_50_MHZ, GPIO_CNF_OUTPUT_ALTFN_PUSHPULL, hw->pin);
	gpio_mode_setup(hw->port, GPIO_MODE_AF,
               GPIO_PUPD_NONE, hw->pin);
   gpio_set_af(hw->port, GPIO_AF7, hw->pin);//??AF7 or AF8??
