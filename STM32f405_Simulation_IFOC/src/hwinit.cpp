...
{	//TODO STM32F4 AMRC
  // rcc_clock_setup_pll(&rcc_hse_configs[RCC_CLOCK_HSE8_72MHZ]);
   ...
   ////GARBAGE:rcc_clock_setup_in_hse_8mhz_out_72mhz()
...
void spi_setup()
{
  //TODO STM32F4 AMRC
   ...
   gpio_mode_setup(GPIOB, GPIO_MODE_AF,
               GPIO_PUPD_NONE, GPIO5 | GPIO3);
   gpio_set_af(GPIOB, GPIO_AF5, GPIO5 | GPIO3 );//??AF5 or AF6??
...
//TODO STM32F4 AMRC
   ...
   if ( activeLow ){  
	gpio_mode_setup(GPIOA, GPIO_MODE_INPUT, GPIO_PUPD_NONE, GPIO8 | GPIO9 | GPIO10);
	  ...
	  gpio_mode_setup(GPIOA, GPIO_MODE_AF,
               GPIO_PUPD_NONE, GPIO8 | GPIO9 | GPIO10);
   ...
   //gpio_set_mode(GPIOB, outputMode, outputConf, GPIO13 | GPIO14 | GPIO15);
	...
	gpio_mode_setup(GPIOB, GPIO_MODE_INPUT, GPIO_PUPD_NONE, GPIO13 | GPIO14 | GPIO15);
		...
		gpio_mode_setup(GPIOB, GPIO_MODE_AF,
               GPIO_PUPD_NONE, GPIO13 | GPIO14 | GPIO15);
   gpio_set_af(GPIOB, GPIO_AF1, GPIO13 | GPIO14 | GPIO15); 
...
void nvic_setup(void)
{
   ...
   nvic_set_priority(PWM_TIMER_IRQ, 1 << 8); //Set second-highest priority//TODO 1<< 4 ??

   nvic_enable_irq(NVIC_TIM1_BRK_TIM9_IRQ /*//TODO STM32F4 AMRC NVIC_TIM1_BRK_IRQ*/); //Emergency shut down
   nvic_set_priority(NVIC_TIM1_BRK_TIM9_IRQ /*//TODO STM32F4 AMRC NVIC_TIM1_BRK_IRQ*/, 0); //Highest priority
   ...
   {
	    nvic_enable_irq(NVIC_TIM5_IRQ); //Scheduler2
      nvic_set_priority(NVIC_TIM5_IRQ, 1 << 4 /**0xe << 4**/); // priority//TODO AMRC ??
...
{  //TODO AMRC
   ...
   //rtc_set_counter_val(0);
	...
	systick_set_reload(rcc_ahb_frequency / 100 - 1 );//??
	systick_clear();
...
void tim_setup()
{
  ...
  gpio_mode_setup(GPIOB, GPIO_MODE_AF,
               GPIO_PUPD_NONE, GPIO7 | GPIO8 | GPIO9);
   gpio_set_af(GPIOB, GPIO_AF2, GPIO7 | GPIO8 | GPIO9);//??AF2??
