...
#define NUM_SERIES_CELL (7.0*12.0/*/2*/)
float temp_bat=-9.1;
...
float battery_simulation::get_VDC(){//TODO implement in real
	...
	if (1==2 /*n==0*/){VDC=VDC_BAT;/*VDC_cond=VDC;*/}//VDC_cond -> VDC con modelo de condensador e resistencia
	else{
	...
	//if (n%2 == 0 /*&& n != 0*/){
//_//			fTorque<<"V__D_C__temp_bat: "<<V__D_C__temp_bat<<" SOC: "<<SOC<<endl;
//		}
	float R_cell=25.0;
	if (temp_bat>=-10.0&&temp_bat<0.0){
