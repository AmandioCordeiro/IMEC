...
//class Tr_c{//TODO-retirar?
	//public:
	//Tr_c(){};

	//void start_thread_Tr(){
		//if (Tr_thread){cout<<"já há Tr_thread"<<endl;}else
		//{cout <<"thread"<<endl;Tr_thread=new std::thread (/*[this]*//*{*/(control.thread_Tr()));////atencao (()) //TODO(trocar por return da funcao)
	//	Tr_thread->/*detach*/join();}
		//else {lthread->detach();};
	//};
//};
...
int main(int argc, char *argv[]){
	...
	//Tr_c start_thread_Tr_o;//TODO-retirar?
	RunButton Run_;
	//Quit Quit_;
	WRefmm	WRefmm_;
	WRefmimi WRefmimi_;
...
{	//lock_guard<mutex> guard (mu);
	...
	//control.signal_Tr.connect(sigc::mem_fun(start_thread_Tr_o,&Tr_c::start_thread_Tr));//TODO-retirar?
	/*if(pQuit)
    { 
